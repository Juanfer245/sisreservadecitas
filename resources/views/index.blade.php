...
<head>
  ...
  <title>Lexxa Dental - Reserva</title>
...
<body class="index-page">
    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:lexxadental@gmail.com">lexxadental@gmail.com</a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>+593 992717253</span></i>
        </div>
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="{{url('/')}}" class="logo d-flex align-items-center me-auto">
          ...
          <h1 class="sitename">Lexxa Dental</h1>
        </a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section light-background">
      ...
      <img src="assets/img/logo_lexa.jpeg" alt="" data-aos="fade-in">

      <div class="container position-relative">

        <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
          <h2>Bienvenido</h2>
          <p>Al centro odontológico Lexxa Dental</p>
        </div><!-- End Welcome -->
